...
import MemberForm from "./memberForm";
  ...
  function PhcForm() {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
      ...
      if (nameParts.length === 1) {
        ...
        setFormData({
          ...formData,
          [nestedKey]: {
            ...formData[nestedKey as keyof typeof formData],
            [subKey]: value,
          },
        });
      }
    ...
    const handleMemberChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>, index: number) => {
      const { name, value } = e.target;
      ...
      if (nameParts.length === 1) {
        ...
        updatedMemberForms[index] = {
          ...updatedMemberForms[index],
          [nestedKey]: {
            ...updatedMemberForms[index][nestedKey as keyof typeof updatedMemberForms[number]],
            [subKey]: value,
          },
        };
      }
